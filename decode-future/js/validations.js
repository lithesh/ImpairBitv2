...
function showErrMsg(errmsg)
{
	...
	str1+="<tr>\n<td><font style='color:red;font-weight:bold;font-size:11;font-family:arial;'>\n</font>\n</td>\n<td style='font-size:11px;color:red;font-weight:bold;font-family:arial;'>"+errmsg+"</td></tr>";
        str1+="</table>";
        var loc=window.parent.frames["errorframe"];
...
function showErrMsg(errmsg,fieldName)
{
        var str1="";
        str1+="<table align=center cellpadding=0 cellspacing=0 class='errorarea' style='font-size:14px;'>";
		str1+="<tr onclick='window.parent.frames[\"mainframe\"].document.forms[0]."+fieldName+".focus()' style='color:red;font-weight:bold;font-size:11;font-family:arial;cursor:hand'><td>"+errmsg+"</td></tr>";	
        str1+="</table>";
		var loc=window.parent.frames["errorframe"];
        loc.document.write("<Body>");
        loc.document.write(str1);
...
function WaitMsg(errmsg,imgmsg)
{
        var str1="";
        str1+="<table align=center cellpadding=0 cellspacing=0 class='errorarea' style='font-size:14px;'>";
		str1+="<tr>\n<td><font style='color:red;font-weight:bold;font-size:11;font-family:arial;'>\n</font>\n</td>\n<td style='font-size:11px;color:red;font-weight:bold;font-family:arial;'>"+errmsg.toUpperCase()+"<img src='"+imgmsg+"' width='30' height='6'></td></tr>";
        str1+="</table>";
        var loc=window.parent.frames["errorframe"];
        loc.document.write("<Body>");
        loc.document.write(str1);
...
function WaitMg(errmsg)
{
		...
		var str1="";
        str1+="<table align=center cellpadding=0 cellspacing=0 class='errorarea' style='font-size:14px;'>";
		str1+="<tr>\n<td ><font style='color:red;font-weight:bold;font-size:11;font-family:arial;'>\n</font>\n</td>\n<td style='font-size:11px;color:red;font-weight:bold;font-family:arial;'>Please wait for Response <img src='./images/ajax-loader.gif' width='10'></td></tr>";
        str1+="</table>";
        var loc=window.parent.frames["errorframe"];
        loc.document.write("<Body>");
        loc.document.write(str1);
...
function forcash()
{
	...
	if(ind=='CSH' && (amtloaded<0 || amtloaded>50000))
	{
        ...
        str2+="<tr onclick='window.parent.frames[\"mainframe\"].document.forms[0].AMT_RECEIVED.select()' style='cursor:hand'><td><font style='color:red;font-weight:bold;font-size:13px'>At Amount Received \n</font>\n</td>\n<td>: Amount Should Not Be Greater Than 50,000 If Payment Mode Is Cash</td></tr>";
        str2+="</table>";
        return(str2);
	}
	else
...
function formNames()
{
	var sty1="color:red;font-weight:bold;font-size:11;font-family:arial;";
...
{	
	str1+="<table align=center cellpadding=0 cellspacing=0 class='errorarea' style='font-size:14px;'>";
     	str1+="<tr onclick='window.parent.frames[\"mainframe\"].document.forms[0]."+val+".focus()' style='cursor:hand'><td><font style='color:red;font-weight:bold;font-size:11;font-family:arial;'>At "+val1+" : \n</font>\n</td>\n<td style='font-size:11px;color:green;font-weight:bold;font-family:arial;'>Please add atleast one row</td></tr>";
     	str1+="</table>";
	return str1;
}
	else
